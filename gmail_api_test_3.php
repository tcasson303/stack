...
if (!isset($_SESSION['ACCESS_TOKEN'])) {
  ...
  for ($i = $last; $i >= $last-20; $i-- ){ 
    ...
    $imgfile[$i] = "./users/$newdir/$mfile.png";
    $multiimgfile[$i] = "./users/$newdir/$mfile-0.png";
    ...
    echo '<div id="search' . $i . '" style="{border:1px solid blue}" class="mailbrick"><img src="' . $multiimgfile[$i] . '">' . "\n";
    } else {
    echo '<div id="search' . $i . '" style="{border:1px solid blue}" class="mailbrick"><img src="' . $imgfile[$i] . '">' . "\n";
    }
    echo '<h5>Subject: ' . $storage->getMessage($i)->subject . '</h5><h5>Type:' . $type . '</h5></div>' . "\n";
